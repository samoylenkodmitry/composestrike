...
const val IS_LOCALHOST = true
const val FRONT_TALK_TO_LOCALHOST = false
val SERVER_PORT = if (IS_LOCALHOST) 8080 else 80
val hostDebug = "0.0.0.0"
val hostRelease = "strike.dmitrysamoylenko.in"
...
class EndpointWithArg<A : Any, R : Any>(
    val arg: A?,
    val aCls: KClass<A>,
    val path: String,
    val rCls: KClass<R>,
